...
async function generarReporteLaboratorio(datos) {
  ...
  if (equipos.length === 0) {
    ...
    autoTable(doc, {
      ...
      head: [[
        { content: 'Clave Activo',  styles: { cellWidth: 26 } },
        { content: 'Marca',         styles: { cellWidth: 24 } },
        { content: 'Modelo',        styles: { cellWidth: 26 } },
        { content: 'Estatus',       styles: { halign: 'center', cellWidth: 22 } },
        { content: 'Valor',         styles: { halign: 'right',  cellWidth: 22 } },
        { content: 'Horas Acum.',   styles: { halign: 'center', cellWidth: 18 } },
        { content: 'Límite Hrs',    styles: { halign: 'center', cellWidth: 16 } },
