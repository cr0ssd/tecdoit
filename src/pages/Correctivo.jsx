...
async function generarReportePDF(clave, tickets, equipoInfo, labInfo) {
  // Named imports — applyPlugin is required to attach autoTable to jsPDF instances
    ...
    <div className="dashboard-container">
      ...
      <section className="table-container">
        <table className="data-table">
          <thead>
            <tr><th>#</th><th>Equipo</th><th>Descripción de la falla</th><th>Proveedor</th><th>Fecha programada</th><th>Costo</th><th>Prioridad</th><th>Estatus</th><th>Acciones</th></tr>
          </thead>
          <tbody>
            {cargando ? (
